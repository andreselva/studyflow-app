...
export const ClearAllPanel = ({ onClearAll }: ClearAllPanelProps) => {
  ...
  return (
    <>
      ...
      {step === 1 && (
        <div className="flex max-w-[calc(100vw-1.5rem)] flex-wrap items-center gap-2 rounded-2xl border border-[#e7c2c2] bg-white/95 px-3 py-2 shadow-md backdrop-blur">
      ...
      {step === 2 && (
        <div className="flex max-w-[calc(100vw-1.5rem)] flex-wrap items-center gap-2 rounded-2xl border border-[#c94f4f] bg-[#fff4f4]/95 px-3 py-2 shadow-md backdrop-blur">
